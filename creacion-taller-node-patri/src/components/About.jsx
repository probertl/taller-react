    ...
    <div className="container text-center">
      <div className="row">
        <div className="col">
          ...
          <img src={platja} alt="Platja" className="img-fluid" />{/*gracies a la clase de boostrap img-fluid garanteix que la imatge sigui responsiva a tots els dispositius*/}
